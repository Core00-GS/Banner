...
<img src="src/main/resources/assets/banner/logo.png">
  <h1>Mohist Banner 1.20.3</h1>

### The Bukkit/Spigot/Paper API implementation for Fabric
### This project has nothing to do with cardboard and uses a completely different development structure
[![](https://img.shields.io/jenkins/build?jobUrl=https%3A%2F%2Fci.codemc.io%2Fjob%2FMohistMC%2Fjob%2FBanner-1.20.3&label=Jenkins&logo=jenkins&logoColor=%23ffffff)](https://ci.codemc.io/job/MohistMC/job/Banner-1.20)
...
- This version of Banner 1.20.3, supports MC version 1.20.3
...
## Progress
- [ ] Start patch
    * [x] Bukkit([**adcf6347**](https://hub.spigotmc.org/stash/projects/SPIGOT/repos/bukkit/commits/43373c44))
    * [ ] CraftBukkit([**8232a74cf**](https://hub.spigotmc.org/stash/projects/SPIGOT/repos/craftbukkit/commits/a2fafdd))
